...
export class EcRucValidator implements IdentifierValidator {
    ...
    private static readonly COEFFICIENTS_PRIVATE = [4, 3, 2, 7, 6, 5, 4, 3, 2] as const;
    private static readonly COEFFICIENTS_PUBLIC = [3, 2, 7, 6, 5, 4, 3, 2] as const;
    ...
    private validatePrivateCompany(value: string): ValidationResult {
        ...
        const expectedVerifier = this.computeMod11Verifier(value, EcRucValidator.COEFFICIENTS_PRIVATE);
    ...
    private validatePublicEntity(value: string): ValidationResult {
        ...
        const expectedVerifier = this.computeMod11Verifier(value, EcRucValidator.COEFFICIENTS_PUBLIC);
    ...
    private computeMod11Verifier(value: string, coefficients: readonly number[]): number {
        let sum = 0;
